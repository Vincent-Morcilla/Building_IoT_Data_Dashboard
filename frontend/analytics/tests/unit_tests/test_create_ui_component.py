...
def test_create_ui_component_dropdown():
    ...
    assert isinstance(ui_component_dropdown, html.Div), "Expected html.Div for dropdown component"
    assert isinstance(ui_component_dropdown.children[1], dcc.Dropdown), "Expected dcc.Dropdown as child of dropdown component"